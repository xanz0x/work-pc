...
```
Проверка: `curl -s -o /dev/null -w "%{http_code}" https://intelligent-library-2.preview.emergentagent.com/login` → 200.
...
## 4. Тестовые данные
- admin / <APP_PASSWORD> (см. `memory/test_credentials.md`).
