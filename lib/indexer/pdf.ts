...
/**
 * Байты → строка с взаимно однозначным соответствием (настоящий latin1).
 * TextDecoder('latin1') в WHATWG на самом деле декодирует windows-1252:
 * байты 0x80–0x9F превращаются в типографские знаки (€ ‚ „ …), из-за чего
 * обратное восстановление байтов в maybeUtf8 ломалось на кириллице
 * (вторые байты UTF-8 для русских букв — это как раз 0x80–0x9F).
 * Поэтому собираем коды символов вручную, кусками против лимита аргументов.
 */
