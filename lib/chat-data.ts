...
/**
 * Демо-разговор: остаётся в рельсе как сохранённая сессия, а не как старт.
 ...
 */
export function seedSession(now: number, scanned: number): Session {
