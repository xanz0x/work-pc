...
export const SETTING_ENTRIES: { id: string; title: string; sub: string; words: string[] }[] = [
  ...
  { id: 'sync', title: 'Синхронизация', sub: 'Настройки · E2EE между устройствами, фраза, устройства', words: ['синхронизация', 'sync', 'устройства', 'фраза', 'e2ee', 'шифрование', 'второе устройство'] },
]
