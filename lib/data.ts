...
export const ENGINES = [
  {
    ...
    short: 'Локальный',
    badge: 'рекомендуем',
    sub: DESKTOP_BUILD ? 'ИИ работает на главном ПК. Друг подключается к нему по защищённому соединению.' : 'ИИ работает через Ollama на сервере приложения, без внешнего ИИ-провайдера.',
    offline: true,
  },
  {
    id: 'hybrid',
