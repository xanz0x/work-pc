...
> Файл-инструкция для продолжения в новом чате. Обновлено 06.2026 (после LG-3).
...
Кодовая часть волны 3 закрыта. Осталась приёмка и необязательный долг.
...
### 2.2 Узкие подписки — остальные экраны (по желанию, P1)
