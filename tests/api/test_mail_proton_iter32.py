...
Прогон: APP_URL=https://intelligent-library-2.preview.emergentagent.com \
...
BASE = os.environ.get("APP_URL", "https://intelligent-library-2.preview.emergentagent.com").rstrip("/")
