...
Прогон: APP_URL=https://library-storage-sync.preview.emergentagent.com \
...
BASE = os.environ.get("APP_URL", "https://library-storage-sync.preview.emergentagent.com").rstrip("/")
