...
Прогон: APP_URL=https://screen-breakdown-1.preview.emergentagent.com \
...
BASE = os.environ.get("APP_URL", "https://screen-breakdown-1.preview.emergentagent.com").rstrip("/")
