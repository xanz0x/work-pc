    ...
    <section className="sec panel" id="set-flags" data-testid="settings-flags">
      <div className="sec-head">
        ...
        <div className="sec-head-text">
          <h2 className="setting-title" data-testid="settings-flags-title">Автономный режим и флаги</h2>
      ...
      <div className="field-block">
        ...
        {blocked.length === 0 ? (
          <div className="stat-line set-empty" data-testid="flags-blocked-empty">
            В этой сессии нет заблокированных запросов.
          </div>
        ) : (
          <>
