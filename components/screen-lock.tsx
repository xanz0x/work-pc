...
import { RecoveryDialog } from './recovery-key-dialog'
...
export function ScreenLock() {
  ...
  return (
    ...
    >
      ...
      <div className="access-brand" data-testid="lock-brand"><LogoWord testId="lock-brand-image" /></div>
      ...
      {resetting && <RecoveryDialog onClose={() => setResetting(false)} />}
    </div>
  )
}
