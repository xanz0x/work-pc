...
/* Сплэш холодного старта: знак и название плавно проявляются,
    ...
    >
      <div className="splash-inner">
        <span className="splash-mark" aria-hidden="true">
          <IconLogoMark data-testid="splash-logo-mark" />
        </span>
        <LogoWord className="splash-word" withMark={false} testId="splash-logo-wordmark" />
