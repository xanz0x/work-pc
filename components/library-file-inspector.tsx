...
export function LibraryFileInspector({
  ...
  onDeleteRequest: (r: { id: string; title: string; absPath: string | null; cloudId: string | null }) => void
        ...
        {selFile?.shared && isAdmin ? (
          ...
          <button
            ...
            onClick={() => {
              ...
              onDeleteRequest({ id: selFile.id, title: selFile.name, absPath: selFileAbsPath, cloudId: selFile.cloudId ?? null })
            }}
