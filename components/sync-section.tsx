    ...
    <section className="sec panel" id="set-sync" data-testid="settings-sync">
      <div className="sec-head">
        ...
        <div className="sec-head-text">
          <h2 className="setting-title" data-testid="settings-sync-title">Синхронизация между устройствами</h2>
      ...
      {!on ? (
        <div className="sync-setup">
          <input
            ...
            aria-label="Имя этого устройства"
            value={label}
            maxLength={40}
          ...
          <div className="sync-cards">
            ...
            <div className="sync-card" data-testid="sync-join-card">
              ...
              <textarea
                ...
                aria-label="Фраза синхронизации — 12 слов"
                value={phrase}
                rows={2}
