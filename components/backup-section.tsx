    ...
    <section className="sec panel" id="set-backup" data-testid="settings-backup">
      <div className="sec-head">
        ...
        <div className="sec-head-text">
          <h2 className="setting-title" data-testid="settings-backup-title">Бэкап всего сейфа</h2>
      ...
      <div className="field-block">
        ...
        {snaps.length === 0 ? (
          <div className="stat-line set-empty" data-testid="backup-empty">Сохранённых снимков пока нет.</div>
        ) : (
      ...
      <div className="field-block">
        ...
        {blob && !pending && (
          <div className="folder-row" data-testid="backup-open-row">
            ...
            <button className="btn btn-ghost btn-sm" onClick={() => setBlob(null)} data-testid="backup-open-cancel">
              Отмена
            </button>
          </div>
        )}
