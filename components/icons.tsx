...
/** Прозрачный знак WX из одобренного логотипа; прежний размер SVG-слота сохранён. */
export function IconLogoMark(p: P) {
  return (
    <svg viewBox="0 0 662 388" fill="none" focusable="false" {...p}>
      <image href="/brand/workspacex-mark.png" width="662" height="388" />
    </svg>
  )
}
