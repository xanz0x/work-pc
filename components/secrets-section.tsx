    ...
    <section className="sec panel" id="set-secrets" data-testid="settings-secrets">
      <div className="sec-head">
        ...
        <div className="sec-head-text">
          <h2 className="setting-title" data-testid="settings-secrets-title">Менеджер секретов</h2>
          <div className="setting-note">
            Буфер обмена, авто-скрытие, иконки сайтов и изоляция от ИИ
          </div>
        </div>
        <span className="sec-meta label-mono" data-testid="settings-secrets-save-mode">Применяется сразу</span>
      </div>
      ...
      <p className="sec-note" data-testid="settings-clipboard-warning">
        Очистка буфера в браузере не удаляет историю буфера обмена в других программах.
      </p>
    </section>
  )
}
